...
//   var navlinks = element.querySelectorAll('a');
//   for (const navlink of navlinks) {
//     if (navlink.href.includes(route.path)) {
//       navlink.click();
//       break;
//     }
//   }
...
//     );
//     navbar = element.shadowRoot.querySelector('vaadin-tabs');
//   });

//   it('should include a navbar', async () => {
//     const target = element.shadowRoot.querySelectorAll('vaadin-tabs');
