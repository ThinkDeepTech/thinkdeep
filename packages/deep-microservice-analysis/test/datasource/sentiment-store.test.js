...
describe('sentiment-store', () => {
  ...
  describe('readMostRecentSentiments', () => {
    it('should return immediately if economic entity name is not a string', async () => {
      ...
      await subject.readMostRecentSentiments(
        economicEntityName,
        economicEntityType
      );
    ...
    it('should return sentiments associated with economic entity name and type', async () => {
      ...
      expect(findArg.economicEntityName).to.equal(
        economicEntityName.toLowerCase()
      );
      expect(findArg.economicEntityType).to.equal(
        economicEntityType.toLowerCase()
      );
    });
    ...
    it('should return an empty array on read failure', async () => {
      ...
      const result = await subject.readMostRecentSentiments(
        economicEntityName,
        economicEntityType
      );
  ...
  describe('createSentiments', () => {
    it('should return immediately if economic entity name is not a string', async () => {
      ...
      await subject.createSentiments(
        timestamp,
        economicEntityName,
        economicEntityType,
        sentiments
    ...
    it('should insert the sentiments', async () => {
      ...
      const success = await subject.createSentiments(
        timestamp,
        economicEntityName,
        economicEntityType,
        sentiments
