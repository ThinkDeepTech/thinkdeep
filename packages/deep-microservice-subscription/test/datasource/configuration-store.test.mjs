...
// import { ConfigurationStore } from '../../src/datasource/configuration-store.mjs';
...
//             subject.createConfigurationForUser(userEmail, { observedEconomicEntities: null}).then(() => {
//                 done('An error was not thrown');
//             }, (reason) => {
//                 done();
//             })
...
//             expect(collection.insertOne).to.have.been.calledOnce;
//         })
//     })
...
//         it('should throw an error if an invalid configuration is supplied', (done) => {
//             const userEmail = 'somevalid@email.com';
//             subject.updateConfigurationForUser(userEmail, { observedEconomicEntities: null}).then(() => {
//                 done('An error was not thrown');
//             }, (reason) => {
//                 done();
//             })
...
//             expect(collection.updateOne).to.have.been.calledOnce;
//         })
//     })
// })